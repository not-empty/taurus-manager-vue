import { BaseEntity, BaseRepository, ListOptions, PaginatedResult } from "../../../core/BaseRepository";
...
export class QueueRepository extends BaseRepository<Queue> {
  ...
  public async listWithGroup(options: ListOptions<QueueWithGroup> = {}): Promise<PaginatedResult<QueueWithGroup>> {
